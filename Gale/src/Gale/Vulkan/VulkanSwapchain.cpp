...
namespace Gale {
	...
	void VulkanSwapchain::CreateSwapchain()
	{
		...
		//GL_INFO("Swapchain Extent {} {}", m_Extent.width, m_Extent.height);
		...
		//GL_INFO("Format {}, Colorspace {}", string_VkFormat(surfaceFormat.format), string_VkColorSpaceKHR(surfaceFormat.colorSpace));
	...
	{
		//GL_TRACE("Surface formats avalible:");
		VkSurfaceFormatKHR format = formats[0];
		for (const auto& availableFormat : formats) 
		{
			//GL_TRACE("	{}, {}", string_VkFormat(availableFormat.format), string_VkColorSpaceKHR(availableFormat.colorSpace));
	...
	{
		//GL_TRACE("Swapchain present modes avalible:");
		VkPresentModeKHR presentMode = VK_PRESENT_MODE_FIFO_KHR;
		for (const auto& availablePresentMode : presentModes) 
		{
			//GL_TRACE("	{}", string_VkPresentModeKHR(availablePresentMode));
